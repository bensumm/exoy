...
public final class ComputationScheduler extends Scheduler implements SchedulerMultiWorkerSupport {
    ...
    public void start() {
        ...
        if (UByte$$ExternalSyntheticBackport0.m(this.pool, NONE, fixedSchedulerPool)) {
            return;
        }
        fixedSchedulerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(this.pool, fixedSchedulerPool, fixedSchedulerPool2));
        fixedSchedulerPool.shutdown();
    }
