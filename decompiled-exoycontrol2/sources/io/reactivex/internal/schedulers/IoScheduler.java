...
public final class IoScheduler extends Scheduler {
    ...
    public void start() {
        ...
        if (UByte$$ExternalSyntheticBackport0.m(this.pool, NONE, cachedWorkerPool)) {
            return;
        }
        cachedWorkerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(this.pool, cachedWorkerPool, cachedWorkerPool2));
        cachedWorkerPool.shutdown();
    }
