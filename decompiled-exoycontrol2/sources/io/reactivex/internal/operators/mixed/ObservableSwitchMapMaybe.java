    ...
    static final class SwitchMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapMaybeObserver, switchMapMaybeObserver3));
        ...
        void innerError(SwitchMapMaybeObserver<R> switchMapMaybeObserver, Throwable th) {
            if (UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapMaybeObserver, null) && this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        void innerComplete(SwitchMapMaybeObserver<R> switchMapMaybeObserver) {
            if (UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapMaybeObserver, null)) {
                drain();
            }
        }
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (!z2 && switchMapMaybeObserver.item != null) {
                    UByte$$ExternalSyntheticBackport0.m(atomicReference, switchMapMaybeObserver, null);
