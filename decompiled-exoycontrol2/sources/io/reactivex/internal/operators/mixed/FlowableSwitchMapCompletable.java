    ...
    static final class SwitchMapCompletableObserver<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapInnerObserver, switchMapInnerObserver2));
        ...
        void innerError(SwitchMapInnerObserver switchMapInnerObserver, Throwable th) {
            if (UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapInnerObserver, null) && this.errors.addThrowable(th)) {
                if (this.delayErrors) {
                    if (this.done) {
        ...
        void innerComplete(SwitchMapInnerObserver switchMapInnerObserver) {
            if (UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapInnerObserver, null) && this.done) {
                Throwable thTerminate = this.errors.terminate();
                if (thTerminate == null) {
                    this.downstream.onComplete();
                } else {
