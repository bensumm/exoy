    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapSingleObserver, switchMapSingleObserver3));
        ...
        void innerError(SwitchMapSingleObserver<R> switchMapSingleObserver, Throwable th) {
            if (UByte$$ExternalSyntheticBackport0.m(this.inner, switchMapSingleObserver, null) && this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (!z2 && switchMapSingleObserver.item != null) {
                    UByte$$ExternalSyntheticBackport0.m(atomicReference, switchMapSingleObserver, null);
