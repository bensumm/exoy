...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public void onError(Throwable th) {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(this.terminalEvent, null, th)) {
    ...
    public void onComplete() {
        if (UByte$$ExternalSyntheticBackport0.m(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {
    ...
    boolean add(BehaviorSubscription<T> behaviorSubscription) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(this.subscribers, behaviorSubscriptionArr, behaviorSubscriptionArr2));
        return true;
    }
