...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo67clone = transition.mo67clone();
        transitionMo67clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo67clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo67clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo67clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo67clone = transition.mo67clone();
        sceneChangeSetup(viewGroup, transitionMo67clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo67clone);
    }
