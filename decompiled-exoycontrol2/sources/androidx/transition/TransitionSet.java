...
public class TransitionSet extends Transition {
    ...
    public Transition mo67clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo67clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo67clone());
        }
