...
public final class SplashScreenViewProvider {
    ...
    public SplashScreenViewProvider(Activity ctx) {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            viewImpl = new ViewImpl31(ctx);
        } else {
            viewImpl = (Build.VERSION.SDK_INT != 30 || Build.VERSION.PREVIEW_SDK_INT <= 0) ? new ViewImpl(ctx) : new ViewImpl31(ctx);
        }
    ...
    private static final class ViewImpl31 extends ViewImpl {
        ...
        public View getIconView() {
            ...
            Intrinsics.checkNotNullExpressionValue(iconView, "platformView.iconView!!");
            return iconView;
        }
