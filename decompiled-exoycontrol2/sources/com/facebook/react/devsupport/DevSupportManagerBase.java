...
public abstract class DevSupportManagerBase implements DevSupportManager {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.6
            ...
            public void run() {
                ...
                if (DevSupportManagerBase.this.mRedBoxSurfaceDelegate == null) {
                    SurfaceDelegate surfaceDelegateCreateSurfaceDelegate = DevSupportManagerBase.this.createSurfaceDelegate(NativeRedBoxSpec.NAME);
                    if (surfaceDelegateCreateSurfaceDelegate != null) {
                        DevSupportManagerBase.this.mRedBoxSurfaceDelegate = surfaceDelegateCreateSurfaceDelegate;
                    } else {
    ...
    public void showDevOptionsDialog() {
        ...
        if (this.mDevOptionsDialog == null && this.mIsDevSupportEnabled && !ActivityManager.isUserAMonkey()) {
            ...
            AlertDialog alertDialogCreate = new AlertDialog.Builder(currentActivity).setCustomTitle(linearLayout).setItems((CharSequence[]) linkedHashMap.keySet().toArray(new String[0]), new DialogInterface.OnClickListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.16
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: renamed from: com.facebook.react.devsupport.DevSupportManagerBase$18, reason: invalid class name */
