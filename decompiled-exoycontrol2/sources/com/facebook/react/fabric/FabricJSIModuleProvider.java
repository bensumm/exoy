...
public class FabricJSIModuleProvider implements JSIModuleProvider<UIManager> {
    ...
    public UIManager get() {
        ...
        new Binding().register(this.mReactApplicationContext.getCatalystInstance().getRuntimeExecutor(), this.mReactApplicationContext.getCatalystInstance().getRuntimeScheduler(), fabricUIManagerCreateUIManager, eventBeatManager, this.mComponentFactory, this.mConfig);
