...
public final class ReadableMapBuffer implements MapBuffer {
    ...
    private final void readHeader() {
        ...
        this.count = m128readUnsignedShortBwKQO78(this.buffer.position()) & UShort.MAX_VALUE;
    }
    ...
    private final int getBucketIndexForKey(int intKey) {
        ...
        short sM820constructorimpl = UShort.m820constructorimpl((short) intKey);
        int count = getCount() - 1;
        while (i <= count) {
            int i2 = (i + count) >>> 1;
            int iM128readUnsignedShortBwKQO78 = m128readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i2)) & UShort.MAX_VALUE;
            int i3 = 65535 & sM820constructorimpl;
            if (Intrinsics.compare(iM128readUnsignedShortBwKQO78, i3) < 0) {
                i = i2 + 1;
            } else {
                if (Intrinsics.compare(iM128readUnsignedShortBwKQO78, i3) <= 0) {
                    return i2;
    ...
    private final MapBuffer.DataType readDataType(int bucketIndex) {
        return MapBuffer.DataType.values()[m128readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(bucketIndex) + 2) & UShort.MAX_VALUE];
    }
    ...
    public final short m128readUnsignedShortBwKQO78(int bufferPosition) {
        return UShort.m820constructorimpl(this.buffer.getShort(bufferPosition));
    }
    ...
    private final class MapBufferEntry implements MapBuffer.Entry {
        ...
        public int getKey() {
            return ReadableMapBuffer.this.m128readUnsignedShortBwKQO78(this.bucketOffset) & UShort.MAX_VALUE;
        }

        @Override // com.facebook.react.common.mapbuffer.MapBuffer.Entry
        public MapBuffer.DataType getType() {
            return MapBuffer.DataType.values()[ReadableMapBuffer.this.m128readUnsignedShortBwKQO78(this.bucketOffset + 2) & UShort.MAX_VALUE];
        }
