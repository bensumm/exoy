...
public class PointerEvent extends Event<PointerEvent> {
    ...
    private WritableMap createW3CPointerEvent(int i) {
        ...
        writableMapCreateMap.putBoolean("isPrimary", this.mEventState.supportsHover(pointerId) || pointerId == this.mEventState.mPrimaryPointerId);
        ...
        writableMapCreateMap.putDouble("offsetX", PixelUtil.toDIPFromPixel(fArr2[0]));
        writableMapCreateMap.putDouble("offsetY", PixelUtil.toDIPFromPixel(fArr2[1]));
        ...
        if (w3CPointerType.equals(PointerEventHelper.POINTER_TYPE_MOUSE)) {
            ...
            writableMapCreateMap.putDouble("width", dIPFromPixel3);
            writableMapCreateMap.putDouble("height", dIPFromPixel3);
        }
        ...
        writableMapCreateMap.putDouble("pressure", PointerEventHelper.getPressure(writableMapCreateMap.getInt("buttons"), this.mEventName));
