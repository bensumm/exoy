...
public class ReactAccessibilityDelegate extends ExploreByTouchHelper {
    ...
    public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (readableArray != null) {
            for (int i = 0; i < readableArray.size(); i++) {
                ...
                String string = map.hasKey(Common.LABEL) ? map.getString(Common.LABEL) : null;
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            if (strNextKey.equals(STATE_SELECTED) && dynamic.getType() == ReadableType.Boolean) {
                ...
                if (accessibilityNodeInfoCompat.getClassName().equals(AccessibilityRole.getValue(AccessibilityRole.SWITCH))) {
                    accessibilityNodeInfoCompat.setText(context.getString(zAsBoolean ? R.string.state_on_description : R.string.state_off_description));
                }
            }
        }
    }
    ...
    private Rect getBoundsInParent(AccessibilityLinks.AccessibleLink accessibleLink) {
        ...
        int iCeil = (int) Math.ceil(r5.measureText(accessibleLink.description));
