...
public class RNCWebChromeClient extends WebChromeClient implements LifecycleEventListener {
    ...
    private PermissionListener webviewPermissionsListener = new PermissionListener() { // from class: com.reactnativecommunity.webview.RNCWebChromeClient$$ExternalSyntheticLambda0
        ...
        public final boolean onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
            return this.f$0.m469lambda$new$0$comreactnativecommunitywebviewRNCWebChromeClient(i, strArr, iArr);
        }
    };
    ...
    public void onProgressChanged(WebView webView, int i) {
        ...
        writableMapCreateMap.putDouble(NotificationCompat.CATEGORY_PROGRESS, i / 100.0f);
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-reactnativecommunity-webview-RNCWebChromeClient, reason: not valid java name */
    /* synthetic */ boolean m469lambda$new$0$comreactnativecommunitywebviewRNCWebChromeClient(int i, String[] strArr, int[] iArr) {
