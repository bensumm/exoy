...
public final class RNGestureHandlerRootHelper {
        ...
        */
        ...
        protected void onCancel() {
            ...
            if (RNGestureHandlerRootHelper.this.getRootView() instanceof RootView) {
                ((RootView) RNGestureHandlerRootHelper.this.getRootView()).onChildStartedNativeGesture(motionEventObtain);
            }
    ...
    /* JADX INFO: renamed from: handleSetJSResponder$lambda-6, reason: not valid java name */
    public static final void m492handleSetJSResponder$lambda6(RNGestureHandlerRootHelper this$0) {
        ...
        if (blockNativeResponder) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.swmansion.gesturehandler.react.RNGestureHandlerRootHelper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RNGestureHandlerRootHelper.m492handleSetJSResponder$lambda6(this.f$0);
                }
            });
        }
    }
