...
public final class RNGestureHandlerEvent extends Event<RNGestureHandlerEvent> {
    ...
    public final <T extends GestureHandler<T>> void init(T handler, RNGestureHandlerEventDataExtractor<T> dataExtractor, boolean useNativeAnimatedName) {
        View view = handler.getView();
        Intrinsics.checkNotNull(view);
        super.init(view.getId());
        this.extraData = INSTANCE.createEventData(handler, dataExtractor);
    ...
    @Override // com.facebook.react.uimanager.events.Event
    /* JADX INFO: renamed from: getCoalescingKey, reason: from getter */
    ...
    public static final class Companion {
        ...
        public final <T extends GestureHandler<T>> RNGestureHandlerEvent obtain(T handler, RNGestureHandlerEventDataExtractor<T> dataExtractor, boolean useTopPrefixedName) {
            ...
            rNGestureHandlerEvent.init(handler, dataExtractor, useTopPrefixedName);
            return rNGestureHandlerEvent;
        }

        public final <T extends GestureHandler<T>> WritableMap createEventData(T handler, RNGestureHandlerEventDataExtractor<T> dataExtractor) {
            Intrinsics.checkNotNullParameter(handler, "handler");
