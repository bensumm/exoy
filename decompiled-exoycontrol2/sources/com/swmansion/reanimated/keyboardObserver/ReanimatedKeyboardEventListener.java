...
public class ReanimatedKeyboardEventListener {
    ...
    public void setupWindowInsets() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(rootView, new OnApplyWindowInsetsListener() { // from class: com.swmansion.reanimated.keyboardObserver.ReanimatedKeyboardEventListener$$ExternalSyntheticLambda1
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return this.f$0.m504x4103b118(rootView, view, windowInsetsCompat);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setupWindowInsets$0$com-swmansion-reanimated-keyboardObserver-ReanimatedKeyboardEventListener, reason: not valid java name */
    /* synthetic */ WindowInsetsCompat m504x4103b118(View view, View view2, WindowInsetsCompat windowInsetsCompat) {
        int i = windowInsetsCompat.getInsets(WindowInsetsCompat.Type.systemBars()).top;
        View viewFindViewById = view.getRootView().findViewById(R.id.action_bar_root);
    ...
    public void bringBackWindowInsets() {
        ...
        View viewFindViewById = getRootView().getRootView().findViewById(R.id.action_bar_root);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -1);
        layoutParams.setMargins(0, 0, 0, 0);
        viewFindViewById.setLayoutParams(layoutParams);
    }
