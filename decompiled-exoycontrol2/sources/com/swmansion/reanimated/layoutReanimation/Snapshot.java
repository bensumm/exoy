...
public class Snapshot {
    ...
    private void addTargetConfig(HashMap<String, Object> map) {
        ...
        map.put(TARGET_BORDER_RADIUS, Float.valueOf(this.borderRadius));
    }
    ...
    private void addCurrentConfig(HashMap<String, Object> map) {
        ...
        map.put(CURRENT_BORDER_RADIUS, Float.valueOf(this.borderRadius));
    }
    ...
    private void addBasicConfig(HashMap<String, Object> map) {
        ...
        map.put("borderRadius", Float.valueOf(this.borderRadius));
    }
