...
public final class ConnectorUtils {
    ...
    public static boolean isAlreadyConnected(ConnectivityManager connectivityManager) {
        ...
        return Elvis.of(connectivityManager).next(new Function() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$$ExternalSyntheticLambda1
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return ((ConnectivityManager) obj).getNetworkInfo(1);
            }
        }).next(new Function() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$$ExternalSyntheticLambda2
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return ((NetworkInfo) obj).getState();
            }
        }).next(new Function() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$$ExternalSyntheticLambda3
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
    ...
    public static boolean isAlreadyConnected(WifiManager wifiManager, ConnectivityManager connectivityManager, String str) {
        ...
        if (!zIsAlreadyConnected || str == null || wifiManager == null) {
    ...
    private static boolean checkForExcessOpenNetworkAndSave(ContentResolver contentResolver, WifiManager wifiManager) {
        ...
        for (int size = configuredNetworks.size() - 1; size >= 0; size--) {
            ...
            if ("OPEN".equals(ConfigSecurities.getSecurity(wifiConfiguration)) && (i2 = i2 + 1) >= i) {
    ...
    private static void sortByPriority(List<WifiConfiguration> list) {
        Collections.sort(list, new Comparator() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$$ExternalSyntheticLambda0
    ...
    private static boolean connectToConfiguredNetwork(WifiManager wifiManager, WifiConfiguration wifiConfiguration, boolean z) {
        ...
        if (iUpdateNetwork == -1 || !wifiManager.enableNetwork(iUpdateNetwork, false) || !wifiManager.saveConfiguration() || (wifiConfiguration2 = ConfigSecurities.getWifiConfiguration(wifiManager, wifiConfiguration)) == null || !disableAllButOne(wifiManager, wifiConfiguration2)) {
            return false;
        }
        if (z) {
            if (!wifiManager.reassociate()) {
    ...
    /* JADX INFO: renamed from: com.thanosfisherman.wifiutils.ConnectorUtils$1, reason: invalid class name */
    class AnonymousClass1 extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            ...
            weakHandler.postDelayed(new Runnable() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$1$$ExternalSyntheticLambda0
        ...
        static /* synthetic */ void lambda$onAvailable$1(WifiManager wifiManager, ScanResult scanResult, WifiConnectionCallback wifiConnectionCallback) {
            if (ConnectorUtils.isAlreadyConnected(wifiManager, (String) Elvis.of(scanResult).next(new Function() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$1$$ExternalSyntheticLambda1
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
    ...
    private static boolean connectAndroidQHidden(WifiManager wifiManager, ConnectivityManager connectivityManager, WeakHandler weakHandler, WifiConnectionCallback wifiConnectionCallback, String str, String str2, String str3) {
        ...
        NetworkRequest networkRequestBuild = new NetworkRequest.Builder().addTransportType(1).addCapability(12).addCapability(13).setNetworkSpecifier(ssid.build()).build();
        DisconnectCallbackHolder.getInstance().disconnect();
    ...
    /* JADX INFO: renamed from: com.thanosfisherman.wifiutils.ConnectorUtils$2, reason: invalid class name */
    class AnonymousClass2 extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            ...
            final WifiConnectionCallback wifiConnectionCallback = this.val$wifiConnectionCallback;
            weakHandler.postDelayed(new Runnable() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
            ...
            for (WifiConfiguration wifiConfiguration2 : configuredNetworks) {
                if (wifiConfiguration2 != null) {
                    if (wifiConfiguration2.networkId == wifiConfiguration.networkId) {
                        zEnableNetwork = wifiManager.enableNetwork(wifiConfiguration2.networkId, true);
                    } else {
    ...
    static void connectWps(final WifiManager wifiManager, final WeakHandler weakHandler, final ScanResult scanResult, String str, long j, final ConnectionWpsListener connectionWpsListener) {
        ...
        final Runnable runnable = new Runnable() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils.3
            @Override // java.lang.Runnable
            public void run() {
        ...
        WifiManager.WpsCallback wpsCallback = new WifiManager.WpsCallback() { // from class: com.thanosfisherman.wifiutils.ConnectorUtils.4
            ...
            public void onFailed(int i) {
                ...
                if (i == 3) {
                    ...
                    strValueOf = i != 7 ? String.valueOf(i) : "WPS_TIMED_OUT";
                } else {
