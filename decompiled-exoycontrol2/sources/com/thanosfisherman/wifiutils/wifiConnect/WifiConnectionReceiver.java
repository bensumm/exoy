...
public final class WifiConnectionReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("android.net.wifi.STATE_CHANGE".equals(action)) {
            if (ConnectorUtils.isAlreadyConnected(this.mWifiManager, (String) Elvis.of(this.mScanResult).next(new Function() { // from class: com.thanosfisherman.wifiutils.wifiConnect.WifiConnectionReceiver$$ExternalSyntheticLambda0
        ...
        if ("android.net.wifi.supplicant.STATE_CHANGE".equals(action)) {
            ...
            if (i == 1 || i == 2) {
                if (this.mScanResult == null && isAlreadyConnected2(this.mWifiManager, this.ssid)) {
                    ...
                    if (ConnectorUtils.isAlreadyConnected(this.mWifiManager, (String) Elvis.of(this.mScanResult).next(new Function() { // from class: com.thanosfisherman.wifiutils.wifiConnect.WifiConnectionReceiver$$ExternalSyntheticLambda1
                        @Override // androidx.arch.core.util.Function
                        public final Object apply(Object obj) {
                            return ((ScanResult) obj).BSSID;
                        }
    ...
    /* JADX INFO: renamed from: com.thanosfisherman.wifiutils.wifiConnect.WifiConnectionReceiver$1, reason: invalid class name */
