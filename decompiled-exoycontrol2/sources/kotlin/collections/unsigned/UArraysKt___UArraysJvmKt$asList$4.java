...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UShort.m814boximpl(m1059getMh2AYeg(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m1060indexOfxj2QHRw(((UShort) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m1061lastIndexOfxj2QHRw(((UShort) obj).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UShortArray.m879getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UShortArray.m881isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m1058containsxj2QHRw(short element) {
        return UShortArray.m874containsxj2QHRw(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public short m1059getMh2AYeg(int index) {
        return UShortArray.m878getMh2AYeg(this.$this_asList, index);
    }

    /* JADX INFO: renamed from: indexOf-xj2QHRw, reason: not valid java name */
    public int m1060indexOfxj2QHRw(short element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: lastIndexOf-xj2QHRw, reason: not valid java name */
    public int m1061lastIndexOfxj2QHRw(short element) {
