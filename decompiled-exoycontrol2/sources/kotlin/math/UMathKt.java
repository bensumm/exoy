...
public final class UMathKt {
    ...
    private static final int m1763minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1745minOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1764mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1753minOfeb3DHEI(j, j2);
    }

    /* JADX INFO: renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1761maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1733maxOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1762maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1741maxOfeb3DHEI(j, j2);
    }
}
