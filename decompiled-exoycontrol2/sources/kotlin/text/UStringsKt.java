...
public final class UStringsKt {
    ...
    public static final String m1851toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1853toStringolVBNx4(short s, int i) {
    ...
    public static final String m1852toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1850toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m634constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m550boximpl(UByte.m556constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m634constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m814boximpl(UShort.m820constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM634constructorimpl = UInt.m634constructorimpl(i);
        int iM$1 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                if (iM$1 == 119304647) {
                    iM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1, iM634constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM634constructorimpl2 = UInt.m634constructorimpl(i3 * iM634constructorimpl);
            int iM634constructorimpl3 = UInt.m634constructorimpl(UInt.m634constructorimpl(iDigitOf) + iM634constructorimpl2);
            if (Integer.compare(iM634constructorimpl3 ^ Integer.MIN_VALUE, iM634constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM634constructorimpl3;
        }
        return UInt.m628boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM713constructorimpl = ULong.m713constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM713constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM713constructorimpl2 = ULong.m713constructorimpl(j * jM713constructorimpl);
            long jM713constructorimpl3 = ULong.m713constructorimpl(ULong.m713constructorimpl(((long) UInt.m634constructorimpl(iDigitOf)) & 4294967295L) + jM713constructorimpl2);
            if (Long.compare(jM713constructorimpl3 ^ Long.MIN_VALUE, jM713constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM713constructorimpl3;
        }
        return ULong.m707boximpl(j);
    }
}
