...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    private final void invokeOnCloseHandler(Throwable cause) {
        ...
        if (obj == null || obj == AbstractChannelKt.HANDLER_INVOKED || !UByte$$ExternalSyntheticBackport0.m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, (Object) null, handler)) {
            Object obj = this.onCloseHandler;
        ...
        if ((obj2 instanceof Closed) && UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo2046trySendJP2dKIU(E element) {
        ...
        return closedOfferInternal != null ? ChannelResult.INSTANCE.m2064closedJP2dKIU(closedOfferInternal.getSendException()) : ChannelResult.INSTANCE.m2066successJP2dKIU(Unit.INSTANCE);
    }
    ...
    private final Closed offerInternal(E element) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new State(element, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, cause == null ? CLOSED : new Closed(cause)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
            for (Subscriber<E> subscriber : subscriberArr) {
