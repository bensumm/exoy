...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m538constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m538constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    */
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend == null || !UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo2090remove()) {
                receive.helpRemove();
            } else {
                objM2082constructorimpl$default = InlineList.m2087plusFjFbRPM(objM2082constructorimpl$default, receive);
            }
        }
        if (objM2082constructorimpl$default != null) {
            if (!(objM2082constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM2082constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM2082constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM2082constructorimpl$default;
    ...
    */
    public final java.lang.Object sendSuspend(E r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L60:
            ...
            java.lang.Object r5 = kotlin.Result.m538constructorimpl(r5)
            r1.resumeWith(r5)
            goto L85
        L76:
