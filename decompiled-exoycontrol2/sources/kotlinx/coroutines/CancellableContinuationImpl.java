...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, cancelHandlerMakeCancelHandler)) {
                    return;
                }
                ...
                if (obj instanceof CompletedContinuation) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandlerMakeCancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                } else {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new CompletedContinuation(obj, cancelHandlerMakeCancelHandler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new CancelledContinuation(this, cause, z)));
