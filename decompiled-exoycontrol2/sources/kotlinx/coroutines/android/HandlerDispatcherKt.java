...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM538constructorimpl = Result.m538constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM538constructorimpl = Result.m538constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m544isFailureimpl(objM538constructorimpl) ? null : objM538constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo2091dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
