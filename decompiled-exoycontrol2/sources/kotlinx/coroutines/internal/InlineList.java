...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m2080boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m2081constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m2086hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public int hashCode() {
        return m2086hashCodeimpl(this.holder);
    }

    public String toString() {
        return m2088toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m2082constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m2081constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m2087plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m2081constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m2081constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m2085forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
