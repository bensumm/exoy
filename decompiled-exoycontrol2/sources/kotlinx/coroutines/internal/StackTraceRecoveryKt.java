...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM538constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM538constructorimpl = Result.m538constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM538constructorimpl = Result.m538constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m541exceptionOrNullimpl(objM538constructorimpl) == null) {
            obj2 = objM538constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM538constructorimpl2 = Result.m538constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM538constructorimpl2 = Result.m538constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m541exceptionOrNullimpl(objM538constructorimpl2) == null) {
            obj = objM538constructorimpl2;
        }
