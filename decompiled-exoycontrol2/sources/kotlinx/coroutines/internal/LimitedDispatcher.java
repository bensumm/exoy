...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2092scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2092scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo2091dispatch(CoroutineContext context, Runnable block) {
        if (addAndTryDispatching(block) || !tryAllocateWorker()) {
            return;
        }
        this.dispatcher.mo2091dispatch(this, this);
    }
