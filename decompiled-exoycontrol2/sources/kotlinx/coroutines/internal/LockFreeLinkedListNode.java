...
public class LockFreeLinkedListNode {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo2090remove()) {
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            UByte$$ExternalSyntheticBackport0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
        }
    ...
    public static class RemoveFirstDesc<T> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            UByte$$ExternalSyntheticBackport0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
            UByte$$ExternalSyntheticBackport0.m(_originalNext$FU, this, (Object) null, prepareOp.next);
        }
        ...
        public Object perform(Object affected) {
            ...
            if (affected != null) {
                ...
                if (objOnPrepare == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, lockFreeLinkedListNode2.removed())) {
                ...
                UByte$$ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, objUpdatedNext);
                return null;
            }
        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r7) {
            ...
            L33:
                ...
                boolean r4 = kotlin.UByte$$ExternalSyntheticBackport0.m(r4, r0, r1, r3)
                if (r4 == 0) goto L0
            ...
            L66:
                ...
                kotlin.UByte$$ExternalSyntheticBackport0.m(r2, r0, r3, r1)
                throw r7
            */
        ...
        public final void complete(AtomicOp<?> op, Object failure) {
            ...
            if (queue == null) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, affectedNode, op, z ? updatedNext(affectedNode, queue) : queue) && z) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0048, code lost:
        ...
        if (kotlin.UByte$$ExternalSyntheticBackport0.m(kotlinx.coroutines.internal.LockFreeLinkedListNode._next$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L30;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
