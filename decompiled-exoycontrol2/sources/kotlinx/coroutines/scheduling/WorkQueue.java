...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue victim) {
        ...
        for (int i2 = victim.consumerIndex; i2 != i; i2++) {
            ...
            if (task != null) {
                if ((task.taskContext.getTaskMode() == 1) && UByte$$ExternalSyntheticBackport0.m(atomicReferenceArray, i3, task, (Object) null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue victim, boolean blockingOnly) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(lastScheduledTask$FU, victim, task, (Object) null));
        add$default(this, task, false, 2, null);
        return -1L;
    }
