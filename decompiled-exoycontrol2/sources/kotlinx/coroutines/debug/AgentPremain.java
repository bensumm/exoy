...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM538constructorimpl = Result.m538constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM538constructorimpl = Result.m538constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m544isFailureimpl(objM538constructorimpl) ? null : objM538constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2068installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2068installSignalHandler$lambda1(Signal signal) {
