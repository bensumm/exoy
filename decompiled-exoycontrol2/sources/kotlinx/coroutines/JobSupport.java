...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final Object finalizeFinishingState(Finishing state, Object proposedUpdate) throws Throwable {
        ...
        boolean zM = UByte$$ExternalSyntheticBackport0.m(_state$FU, this, state, JobSupportKt.boxIncomplete(proposedUpdate));
    ...
    */
    ...
    private final int startInternal(Object state) {
        if (state instanceof Empty) {
            ...
            if (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, state, JobSupportKt.EMPTY_ACTIVE)) {
                return -1;
            }
            onStart();
            return 1;
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.getIsActive()) {
                    if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, state$kotlinx_coroutines_core, jobNodeMakeNode)) {
    ...
    */
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode node) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, state$kotlinx_coroutines_core, JobSupportKt.EMPTY_ACTIVE));
    }
