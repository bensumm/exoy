...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Function0<? extends Object> value, Function0<Unit> block) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, SelectKt.UNDECIDED, value.invoke())) {
                    return;
                }
            } else if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    block.invoke();
                    return;
                }
            } else {
    ...
    public final Object getResult() {
        ...
        Object obj = this._result;
        if (obj == SelectKt.UNDECIDED) {
            if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, SelectKt.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m538constructorimpl(ResultKt.createFailure(e)));
        } else {
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            if (affected != null) {
                ...
                UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, selectBuilderImpl, this, objDecide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return objDecide;
            }
    ...
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final Object prepareSelectOp() {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this.impl, SelectKt.getNOT_SELECTED(), this)) {
                        return null;
                    }
                } else {
        ...
        private final void undoPrepare() {
            UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this.impl, this, SelectKt.getNOT_SELECTED());
        }

        private final void completeSelect(Object failure) {
            boolean z = failure == null;
            if (UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this.impl, this, z ? null : SelectKt.getNOT_SELECTED()) && z) {
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            Object obj = this._result;
            if (obj == SelectKt.UNDECIDED) {
                if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(result, null, 1, null))) {
                    return;
                }
            } else if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    if (Result.m544isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable thM541exceptionOrNullimpl = Result.m541exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(thM541exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            thM541exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM541exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m538constructorimpl(ResultKt.createFailure(thM541exceptionOrNullimpl)));
                        return;
                    }
    ...
    public void resumeSelectWithException(Throwable exception) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                Continuation<R> continuation = this.uCont;
                if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, SelectKt.UNDECIDED, new CompletedExceptionally((DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(exception, (CoroutineStackFrame) continuation) : exception, false, 2, null))) {
                    return;
                }
            } else if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                if (UByte$$ExternalSyntheticBackport0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuationIntercepted.resumeWith(Result.m538constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            } else {
                throw new IllegalStateException("Already resumed");
    ...
    */
    public java.lang.Object trySelectOther(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp r4) {
        ...
        L0:
            ...
            java.lang.Object r1 = kotlinx.coroutines.selects.SelectKt.getNOT_SELECTED()
            boolean r0 = kotlin.UByte$$ExternalSyntheticBackport0.m(r0, r3, r1, r2)
            if (r0 != 0) goto L30
            goto L0
        L18:
            ...
            boolean r1 = kotlin.UByte$$ExternalSyntheticBackport0.m(r1, r3, r2, r0)
            if (r1 == 0) goto L0
