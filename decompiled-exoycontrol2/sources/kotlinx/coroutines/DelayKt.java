...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo2092scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2028delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2029toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2029toDelayMillisLRDsOJo(long j) {
        if (Duration.m1864compareToLRDsOJo(j, Duration.INSTANCE.m1967getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1883getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
