...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
        ...
        while (!select.isSelected()) {
            ...
            if (obj instanceof Empty) {
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, new LockedQueue(empty.locked));
                } else {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        private final class PrepareOp extends OpDescriptor {
            ...
            public Object perform(Object affected) {
                ...
                UByte$$ExternalSyntheticBackport0.m(MutexImpl._state$FU, (MutexImpl) affected, this, atomicOp);
                return null;
            }
        }
        ...
        public Object prepare(AtomicOp<?> op) {
            ...
            if (!UByte$$ExternalSyntheticBackport0.m(MutexImpl._state$FU, this.mutex, MutexKt.EMPTY_UNLOCKED, prepareOp)) {
        ...
        public void complete(AtomicOp<?> op, Object failure) {
            ...
            UByte$$ExternalSyntheticBackport0.m(MutexImpl._state$FU, this.mutex, op, empty);
        }
    }
    ...
    private static final class UnlockOp extends AtomicOp<MutexImpl> {
        ...
        public void complete(MutexImpl affected, Object failure) {
            UByte$$ExternalSyntheticBackport0.m(MutexImpl._state$FU, affected, this, failure == null ? MutexKt.EMPTY_UNLOCKED : this.queue);
        }
    }
    ...
    public boolean tryLock(Object owner) {
        while (true) {
            ...
            if (obj instanceof Empty) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, owner == null ? MutexKt.EMPTY_LOCKED : new Empty(owner))) {
                    return true;
                }
            } else {
                if (obj instanceof LockedQueue) {
    ...
    public void unlock(Object owner) {
        while (true) {
            ...
            if (obj instanceof Empty) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, MutexKt.EMPTY_UNLOCKED)) {
                    return;
                }
                ...
                if (lockFreeLinkedListNodeRemoveFirstOrNull == null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, unlockOp) && unlockOp.perform(this) == null) {
                        return;
                    }
                } else {
