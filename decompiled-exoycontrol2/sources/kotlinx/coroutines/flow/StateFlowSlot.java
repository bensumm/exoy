...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final void makePending() {
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (UByte$$ExternalSyntheticBackport0.m(_state$FU, this, obj, StateFlowKt.NONE)) {
                Result.Companion companion = Result.INSTANCE;
                ((CancellableContinuationImpl) obj).resumeWith(Result.m538constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(_state$FU, this, StateFlowKt.NONE, cancellableContinuationImpl2)) {
