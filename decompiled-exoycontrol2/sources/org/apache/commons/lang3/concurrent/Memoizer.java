...
public class Memoizer<I, O> implements Computable<I, O> {
        ...
        while (true) {
            ...
            if (futurePutIfAbsent == null && (futurePutIfAbsent = this.cache.putIfAbsent(i, (futureTask = new FutureTask(new Callable() { // from class: org.apache.commons.lang3.concurrent.Memoizer$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return this.f$0.m2260lambda$compute$0$orgapachecommonslang3concurrentMemoizer(i);
                }
            })))) == null) {
                futureTask.run();
    ...
    /* synthetic */ Object m2260lambda$compute$0$orgapachecommonslang3concurrentMemoizer(Object obj) throws Exception {
